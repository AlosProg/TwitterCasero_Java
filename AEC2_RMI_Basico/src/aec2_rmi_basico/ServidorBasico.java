...
public class ServidorBasico {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            if (puerto.length() == 0)// si no se introduce nada...
                puerto = "1099"; //... le apsamos el puerto por defecto
            ...
            ServImpl objetoRemoto = new ServImpl();// creamos la instancia del objeto remoto
            String URLregistro = "rmi://localhost:" + puerto + "/hora";// se le asigna una URL
            Naming.rebind(URLregistro, objetoRemoto); // registramos el objeto con sus métodos en el registro en la URL asignada
            System.out.println("Servidor HoraLocal listo.");
        }
